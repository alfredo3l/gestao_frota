  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result) {
        ...
        setFormError('Não foi possível criar o evento. Tente novamente.');
      }
    } catch (error) {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Preencha o formulário para adicionar um novo evento</p>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="notificar" className="ml-2 block text-sm text-gray-700">
                      Notificar participantes sobre este evento
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary resize-none"
                    placeholder="Adicione informações complementares sobre o evento..."
                  ></textarea>
                </div>
              </div>
            </div>
